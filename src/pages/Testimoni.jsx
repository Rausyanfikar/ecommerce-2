  ...
  return (
    <Layout>
      <section class="mb-20 text-gray-700">
        <div class="text-center md:max-w-xl lg:max-w-3xl mx-auto mt-5">
          <h3 class="text-3xl font-bold mb-6 text-gray-800">Testimonials</h3>
          <p class="mb-6 pb-2 md:mb-12 md:pb-0">Testimonial customer yang sudah berbelanja di scarva</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-6 lg:gap-12 text-center">
          <div class="mb-12 md:mb-0">
            ...
            <h5 class="text-xl font-semibold mb-4">Susi Agustina</h5>
            <p class="mb-4">
              ...
              barang yang datang sesuai di foto dan asli love banget deh.
            </p>
          ...
          <div class="mb-12 md:mb-0">
            ...
            <h5 class="text-xl font-semibold mb-4">Sumiati</h5>
            <p class="mb-4">
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="quote-left" class="w-6 pr-2 inline-block" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
                  fill="currentColor"
              ...
              ecommerce sepatu terbaik dan gak nyesel beli sepatu disini.mantap!
            </p>
            <ul class="flex justify-center mb-0">
              <li>
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="w-4 text-yellow-500" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
          ...
          <div class="mb-0">
            ...
            <h5 class="text-xl font-semibold mb-4">Asep Komarudin</h5>
            <p class="mb-4">
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="quote-left" class="w-6 pr-2 inline-block" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path
                  fill="currentColor"
              ...
              tempat wajib beli sepatu ya di scarva !
            </p>
            <ul class="flex justify-center mb-0">
              <li>
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" class="w-4 text-yellow-500" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
